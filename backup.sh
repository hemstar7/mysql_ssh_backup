...
ssh username_ssh@domain.com -t 'mysqldump -u username_mysql -pPasswdMysql --all-databases > /home/username_ssh/homes/mysqlbackup.sql;exit';
echo "Ambil file backup";
scp username_ssh@domain.com:/home/username/homes/mysqlbackup.sql /home/userlocalanda/mysql_$(date +%Y%m%d_%H%M%S).sql;
echo "Selesai Backup ..";
